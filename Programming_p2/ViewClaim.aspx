<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewClaim.aspx.cs" Inherits="Part2_Prog.ViewClaim" %>
...
<body>
    <div class="header">
        <div class="logo">Manager - View Claims</div>
    </div>

    <div class="main-content">
        <form id="form1" runat="server">
            <h2>Welcome, Manager! Review and Manage Lecturer Claims</h2>
